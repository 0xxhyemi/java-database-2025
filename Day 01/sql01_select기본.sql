...
--05. employees 테이블의 이름과 성을 붙여서 full_name으로, phone_number을 출력하시오.(107행)
...
*  full _name(employee_id) - job_id[hire_date] / phone_number 하나의 컬럼에
...
SELECT 
  ...
  * ● NULL비교, LS NULL, IS NOT NULL : NULL값이 아닌 걸 검색할 때
...
SELECT *
  FROM employees
 WHERE job_id LIKE '%MAN';  -- 앞쪽 문자열은 뭐든지 상관없고 MAN으로 끝나는 문자을 가진 패턴 찾아라
...
-- 07. employees에서 hire_date 가 2005-01-01 이후에 입사했고, salary가 10000이상인 직원을 출력하시요.(9행)
